...
class StateMachine:
    def __init__(self) -> None:
        ...
        self.sm.userdata.search_locations = {
            ...
            2: (0.14, 0.60, 1.57),
            3: (-0.34, 0.60,     1.57    ),
            4: (-0.54, 0.60,     1.57    ), #一番手前
            5: (0.74, 0.80, 1.57  ), #中央 
            }
        self.sm.userdata.deposit_locations = {
            #key:{x,y,yaw}
            'kitchen':     (0.84, -0.05, -1.57  ), 
            'tool':        (-0.15, 0.3, -1.57 ),  #right
            'task':        (2.2, 0.0, -1.57 ), 
            'food1':       (1.5,  -0.05, -1.57     ), #right #TODO 増やして，randomでfoodxを回したい
            'food2':       (1.8, -0.05, -1.57    ), #left
            #'food3':       (1.23, -0.20, -1.57    ), #left
            'shape':       (0.36, 0.3, -1.57    ), #left
            'orientation': (1.3, -0.07, -1.57    ), 
