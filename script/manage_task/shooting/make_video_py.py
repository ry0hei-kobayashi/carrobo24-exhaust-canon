...
video_time = 3 * 60.0  # [sec]

print("Make video 0")
files_0 = sorted(glob.glob("./0/*.jpg"))
files_1 = sorted(glob.glob("./1/*.jpg"))
...
video = cv2.VideoWriter('./video.mp4', fourcc, frame_rate, (1920, 1080))
...
for i in range(len(files_0)):
    ...
    pil_main = add_text_to_image(pil_main, "Score: " + str(score).zfill(3), font, 60, (255, 255, 255), 20, 30)

    # hit
    if hit:
        pil_main = add_text_to_image(pil_main, "HIT", font, 61, (0, 0, 0), 101, 31)
        pil_main = add_text_to_image(pil_main, "HIT", font, 60, (230, 0, 0), 100, 30)
    else:
        pil_main = add_text_to_image(pil_main, "HIT", font, 61, (100, 100, 100), 101, 31)
        pil_main = add_text_to_image(pil_main, "HIT", font, 60, (100, 100, 200), 100, 30)

    # drop
    if drop:
        pil_main = add_text_to_image(pil_main, "DROP", font, 61, (0, 0, 0), 171, 31)
        pil_main = add_text_to_image(pil_main, "DROP", font, 60, (230, 0, 0), 170, 30)
    else:
        pil_main = add_text_to_image(pil_main, "DROP", font, 61, (100, 100, 100), 171, 31)
        pil_main = add_text_to_image(pil_main, "DROP", font, 60, (100, 100, 200), 170, 30)

    # meta data
    draw.rectangle((1600, 13, 1910, 280), fill=(150, 150, 150), outline=(255, 255, 255), width=3)
    pil_main = add_text_to_image(pil_main, "Information", font, 40, (255, 255, 255), 20, 1620)
    pil_main = add_text_to_image(pil_main, "Object", font, 30, (255, 255, 255), 80, 1620)
    pil_main = add_text_to_image(pil_main, "- " + str(obj), font, 30, (255, 255, 255), 120, 1620)
    pil_main = add_text_to_image(pil_main, "Category", font, 30, (255, 255, 255), 165, 1620)
    pil_main = add_text_to_image(pil_main, "- " + str(category), font, 30, (255, 255, 255), 205, 1620)
